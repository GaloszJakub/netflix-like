		...
		<div>
			<div className="bg-[url('public/hero_netflix.jpg')] w-full bg-cover bg-no-repeat bg-center text-white relative z-0 pb-40 4xl:text-4xl">
				<div className="container mx-auto">
					...
					<div className="flex flex-row py-6 z-10 pb-28 justify-between">
						<div className="md:px-14 md:basis-1/4 inset-0 scale-75 2xl:scale-100">
							<a href="/">
						...
						<div className="flex flex-row-reverse items-center justify-end md:px-16 pr-4">
							<a href="login" className="bg-[#E50914] px-3 rounded-md py-2 font-bold text-sm text-nowrap text-white">
					...
					<div className="flex flex-col mx-auto px-8 lg:max-w-[45%] text-center">
						...
						<div>
							...
							<div className="flex flex-col md:flex-row mx-auto max-h-32 max-w-[85%] gap-2">
								<input
									type="text"
									id="floating-input"
								...
								<a
									href="login"
									className="bg-[#E50914]  w-full rounded-md font-bold text-sm basis-1/4 text-center my-auto py-2 px-2 text-white block">
									{texts.link}
								</a>
							</div>
						</div>
