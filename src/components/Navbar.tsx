...
export default function Navbar() {
	...
	return (
		<div>
			<div
				className={`h-20 w-screen text-[#a2a2a2]  fixed duration-300 ${
					isScrolled ? 'bg-black' : 'bg-gradient-to-b from-black to-transparent'
				}`}>
				<div className="flex flex-row">
					<div className="scale-75 py-4  pl-8">
					...
					<div className="flex flex-row space-x-4 text-center my-auto">
					...
					<div className="flex flex-row ml-auto py-4 pr-8 space-x-4 my-auto">
						<CiSearch className="my-auto" />
						<CiBellOn className="my-auto" />
						<div className="flex flex-row group space-x-4">
							<div className='bg-[url("/profile1.png")] w-8 h-8 bg-center bg-cover rounded-sm'></div>
