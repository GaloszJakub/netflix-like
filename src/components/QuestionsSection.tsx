...
export default function QuestionsSections() {
	...
	const currentAccordionData = accordionData[language as keyof typeof accordionData]
	return (
		<div className="bg-black text-white px-6 md:px-20 lg:px-36 xl:px-44 2xl:px-56 pb-6 mx-auto">
			<div className="container mx-auto max-w-[1300px]">
				<div className="px-2 md:px-6">
					<h2 className="pt-14 text-2xl font-bold mb-4">
						{language === 'Polski' ? 'Często zadawane pytania' : 'Frequently Asked Questions'}
					</h2>
				</div>
				<div className="md:px-12">
					<div>
						{currentAccordionData.map(({ id, question, answer }) => (
							<Accordion
								key={id}
								sx={{
